...
export function toIopaCarrierResponse(plainresponse, context) {
...
function postMessageDelayForText(text) {
    ...
    const buffer = 900;
    const final = clamp(MIN_POST_MESSAGE_DELAY, delay + buffer, MAX_POST_MESSAGE_DELAY);
    return final;
}
...
//# sourceMappingURL=context-response-connector.js.map