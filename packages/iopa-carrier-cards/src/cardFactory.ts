...
export class CardFactory {
    ...
    public static animationCard(
        ...
        return mediaCard(
            CardFactory.contentTypes.animationCard,
            title,
            media,
            buttons,
            other
    ...
    public static audioCard(
        ...
        return mediaCard(
            CardFactory.contentTypes.audioCard,
            title,
            media,
            buttons,
            other
    ...
    public static heroCard(
        ...
        const a: Attachment = CardFactory.thumbnailCard(
            title,
            text,
            images,
            buttons,
    ...
    public static o365ConnectorCard(card: O365ConnectorCard): Attachment {
        return {
            contentType: CardFactory.contentTypes.o365ConnectorCard,
            content: card,
        }
    }
    ...
    public static receiptCard(card: ReceiptCard): Attachment {
        return {
            contentType: CardFactory.contentTypes.receiptCard,
            content: card,
        }
    }
    ...
    public static signinCard(
        ...
        return {
            contentType: CardFactory.contentTypes.signinCard,
            content: card,
        }
    }
    ...
    public static videoCard(
        ...
        return mediaCard(
            CardFactory.contentTypes.videoCard,
            title,
            media,
            buttons,
            other
    ...
    public static actions(
        actions: (CardAction | string)[] | undefined
    ): CardAction[] {
    ...
    public static images(
        images: (CardImage | string)[] | undefined
    ): CardImage[] {
